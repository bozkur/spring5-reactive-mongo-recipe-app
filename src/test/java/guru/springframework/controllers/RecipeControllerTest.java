...
public class RecipeControllerTest {
    ...
    public void testPostNewRecipeFormValidationFail() throws Exception {
        RecipeCommand command = new RecipeCommand();
        command.setId("2");
        Mono<RecipeCommand> commandMono = Mono.just(command);

        when(recipeService.saveRecipeCommand(any())).thenReturn(commandMono);
    ...
    public void testGetUpdateView() throws Exception {
        ...
        when(recipeService.findCommandById(anyString())).thenReturn(commandMono);
